!(function(e) {
    ...
    Y.use("node", function(e) {
      window.Singleton.create({
        ...
        initializer: function() {
          (this.navShowPosition = 0),
            (this.el = e.one(".show-on-scroll")),
            this.initElOffset();
        },
        initElOffset: function() {
          return this.el
            ? ((this.elOffset = e.one(this.el.getData("offset-el"))),
              (this.offsetBehavior =
                this.el.getData("offset-behavior") || "top"),
              this.elOffset
                ? (e
                    .one("body")
                    .prepend(
                      e.Node.create(
                        '<div class="show-on-scroll-wrapper" id="showOnScrollWrapper"></div>'
                      )
                    ),
                  (this.wrapper = e.one("#showOnScrollWrapper")),
                  this.wrapper.setHTML(this.el._node.outerHTML),
                  void 0)
                : void console.warn("No show on scroll offset element found."))
            : void console.warn("No show on scroll element found.");
        },
        bindUI: function() {
          this.scrollEvents(),
            e.one(window).on(
        ...
        getVariables: function() {
          (this.elOffset || (this.initElOffset(), this.elOffset)) &&
            ("bottom" === this.offsetBehavior
              ? (this.navShowPosition =
                  this.elOffset.getY() + this.elOffset.get("offsetHeight"))
        ...
        scrollLogic: function() {
          window.pageYOffset > this.navShowPosition
            ? this.wrapper.addClass("show")
            : this.wrapper.removeClass("show"),
            e.later(100, this, function() {
              this.scrolling === !0 &&
      ...
      window.Singleton.create({
        ready: function() {
          this.resetGalleryPosition(),
            e.one(".collection-type-index") && this.resetIndexGalleryPosition(),
            e.one(
              ".collection-type-blog.view-list .sqs-featured-posts-gallery"
            ) && e.one("body").addClass("has-banner-image"),
            this.init(),
            this.bindUI(),
            this.syncUI();
        },
        init: function() {
          if (
            ...
            (this._touch = e.one(".touch-styles")),
            e.one(
              ".collection-type-blog.view-list .sqs-featured-posts-gallery"
            ...
            t.inViewportRegion() === !1 && t.addClass("unscrolled"),
              e.one(window).on("scroll", function() {
                t.hasClass("unscrolled") &&
                  t.toggleClass("unscrolled", !t.inViewportRegion());
              });
          }
          var n = Array.prototype.slice.call(
            document.body.querySelectorAll("div.sqs-video-background")
          );
          n.map(function(e) {
            var t = a(e);
            (t.customFallbackImage = t.container.querySelector(
        ...
        bindUI: function() {
          e.one(window).on("resize", this.syncUI, this),
            e.all(".mobile-nav-toggle, .body-overlay").each(function(t) {
              t.on("click", function() {
          ...
          var t = e.throttle(
            e.bind(function() {
              this.bindScroll("#preFooter", 0.6 * e.one("#preFooter").height());
            }, this),
            200
          );
          this._touch || e.one(window).on("scroll", t),
            e.all(".subnav").each(function(t) {
              var n = t._node.getBoundingClientRect();
              n.right > e.config.win.innerWidth && t.addClass("right");
            });
          var n =
            '#sidecarNav a[href^="#"], #sidecarNav a[href^="/#"], #sidecarNav a[href^="/"][href*="#"]';
        ...
        forceMobileNav: function() {
          ...
          if (t) {
            ...
            (r = e.one("#logoWrapper")
              ? parseInt(
                  e.Squarespace.Template.getTweakValue("logoContainerWidth"),
                  10
                )
              : parseInt(
                  e.Squarespace.Template.getTweakValue(
                    "siteTitleContainerWidth"
                  ),
                  10
                )),
              i > this._atLeast
                ? (e.one("body").removeClass("force-mobile-nav"),
                  (n =
                    a.get("offsetWidth") -
                    parseInt(a.getStyle("paddingLeft"), 10) -
                    parseInt(a.getStyle("paddingRight"), 10)),
                  (o = t.get("offsetWidth")),
                  o > n - r &&
                    (e.one("body").addClass("force-mobile-nav"),
                    (this._atLeast = i)))
                : e.one("body").addClass("force-mobile-nav");
          }*/
        },
        makeFeaturedGallery: function(t, n) {
          new e.Squarespace.Gallery2({
            ...
            elements: {
              ...
              previous:
                ".previous-slide, .simple .previous, .sqs-gallery-controls .previous",
              controls: ".dots, .circles",
              currentIndex: ".current-index",
              totalSlides: ".total-slides"
            },
            loop: !0,
            loaderOptions: { load: !0 },
            design: "stacked",
            designOptions: { transition: "fade", clickBehavior: "auto" },
            refreshOnResize: !0
          });
        },
        promotedGalleryShrink: function() {
          ...
          e.one(r) &&
            ((t = e.one("#promotedGalleryWrapper").get("offsetHeight")),
            e.one(".transparent-header") && (t -= 90),
            e.all(r).each(function(e) {
              e.setStyle("display", "block"),
                (n = e.get("offsetHeight")),
                n > t &&
                  ((o = e.ancestor(".slide")),
                  o.addClass("reduce-text-size"),
                  (n = e.get("offsetHeight")),
                  n > t &&
                    (o.removeClass("reduce-text-size"),
                    o.addClass("hide-body-text"),
                    (n = e.get("offsetHeight")),
                    n > t && o.addClass("reduce-text-size"))),
        ...
        textShrink: function(t, n) {
          e.one(t) &&
            e.one(t).ancestor(n) &&
            e.all(t).each(function(t) {
              t.plug(e.Squarespace.TextShrink, { parentEl: t.ancestor(n) });
            });
        },
        resetIndexGalleryPosition: function() {
          var t =
              ".collection-type-index .index-section .sqs-layout > .sqs-row:first-child > .sqs-col-12 > .gallery-block:first-child .sqs-gallery-block-slideshow",
            n =
              ".collection-type-index .index-section .promoted-gallery-wrapper ~ .index-section-wrapper .sqs-layout > .sqs-row:first-child > .sqs-col-12 > .gallery-block:first-child",
            o = e.one(
              ".collection-type-index .index-section:first-child .sqs-layout > .sqs-row:first-child > .sqs-col-12 > .gallery-block:first-child .sqs-gallery-block-slideshow"
            );
          o && e.one("body").addClass("has-banner-image"),
            e.one(t) &&
              (e.one("body").addClass("has-promoted-gallery"),
              e.all(n).each(function(e) {
                e.one(".sqs-gallery-block-slideshow") &&
                  e
                    .ancestor(".index-section-wrapper")
                    .previous(".promoted-gallery-wrapper")
                    .addClass("promoted-full")
                    .append(e);
              }));
        },
        resetGalleryPosition: function() {
          var t = e.one(
              ".collection-type-page .main-content .sqs-layout > .sqs-row:first-child > .sqs-col-12 > .gallery-block:first-child .sqs-gallery-block-slideshow"
            ),
            n = e.one(
              ".collection-type-page .main-content .sqs-layout > .sqs-row:first-child > .sqs-col-12 > .gallery-block:first-child"
            );
          t &&
            (e.one("#promotedGalleryWrapper .row .col").append(n),
            e
              .one("body")
              .addClass("has-promoted-gallery")
              .addClass("has-banner-image"));
        },
        hideArrowsWhenOneSlide: function() {
          e.one(".posts .post:only-child") &&
            e.all(".circles").addClass("hidden");
        },
        repositionCartButton: function() {
          var t = e.one("#header").get("offsetHeight"),
            n = e.one(".sqs-cart-dropzone");
          n &&
            (e.one(".transparent-header.has-banner-image")
              ? n.setStyle("top", t)
              : n.setStyle("top", t + 20));
        },
        showIndexNavOnScroll: function() {
          ...
          if (
            (n(), e.one(".collection-type-index") && window.innerWidth <= 640)
          ) {
            var o = function() {
              t - window.pageYOffset <= 0
                ? e.one("body").addClass("fix-header-nav")
                : e.one("body").removeClass("fix-header-nav");
            };
            e.one(window).on("resize", function() {
              ...
              e
                .one(".mobile-nav-toggle.fixed-nav-toggle")
                .on("click", function() {
                  e.one("body").hasClass("fix-header-nav") &&
                    e.one("body").removeClass("fix-header-nav");
                }),
              e.one(window).on(
        ...
        disableHoverOnScroll: function() {
          ...
          (r.type = "text/css"),
            ...
            window.addEventListener(
              ...
              function() {
                clearTimeout(t),
                  i.classList.contains("disable-hover") ||
  ...
  function(e, t) {
    ...
    (t.default = { isUserAuthenticated: i, openAccountScreen: a }),
      (e.exports = t.default);
  },
  function(e, t, n) {
    var o = n(6).VideoBackground,
      r = n(24);
    e.exports = { VideoBackground: o, getVideoProps: r };
  },
  function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          i(e, [
              ...
              value: function() {
                var e =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : {};
                return (
                  (e = (0, s.default)({}, A.DEFAULT_PROPERTY_VALUES, e)),
                  1 === e.container.nodeType
                    ? (this.container = e.container)
                    : "string" == typeof e.container &&
                      (this.container = document.querySelector(e.container)),
                  this.container
                    ? ((this.videoSource = (0, h.getVideoSource)(e.url)),
                      (this.videoId = (0, h.getVideoID)(
                        e.url,
                        this.videoSource
                      )),
                      (this.customFallbackImage = (0, h.validatedImage)(
                        e.customFallbackImage
                      )),
                      ...
                      (this.playbackSpeed =
                        parseFloat(e.playbackSpeed) < 0.5
                          ? 1
                          : parseFloat(e.playbackSpeed)),
                      (this.timeCode = {
                        start:
                          (0, h.getStartTime)(e.url, this.videoSource) ||
                          e.timeCode.start,
                        end: e.timeCode.end
                      }),
                      (this.player = {}),
                      void (this.DEBUG = e.DEBUG))
                    : (console.error("Container " + e.container + " not found"),
                      !1)
                );
              }
            },
                ...
                if (!(!e || (this.browserCanAutoPlay && this.videoCanAutoPlay)))
                  return (
                    ...
                    this.windowContext.ImageLoader
                      ? void this.windowContext.ImageLoader.load(e, {
                          load: !0
                        })
                      : void (e.src = e.src)
                  );
                  ...
                  n = t({
                    ...
                    readyCallback: function(t, n) {
                      e.player.iframe.classList.add("background-video"),
                        (e.videoAspectRatio = (0, h.findPlayerAspectRatio)(
                          e.container,
                          e.player,
                          e.videoSource
                        )),
                    ...
                    stateChangeCallback: function(t, n) {
                      switch (t) {
                        case "buffering":
                          ...
                          break;
                        case "playing":
                          (null === e.playTimeout && e.videoCanAutoPlay) ||
                ...
                return (
                  ...
                  t === !0
                    ...
                    ? (clearTimeout(this.playTimeout),
                      ...
                      (this.playTimeout = null),
                      (this.videoCanAutoPlay = !1),
                      void this.renderFallbackBehavior())
                    : void 0
                );
              }
            },
              ...
              value: function(e) {
                ...
                if (t) {
                  ...
                  var o = t.parentNode.clientWidth,
                    ...
                    a = 0,
                    s = 0;
                  i > this.videoAspectRatio
                    ? ((a = o * n), (s = (o * n) / this.videoAspectRatio))
                    : this.videoAspectRatio > i
                    ? ((a = r * n * this.videoAspectRatio), (s = r * n))
                    : ((a = o * n), (s = r * n)),
                    (t.style.width = a + "px"),
                    (t.style.height = s + "px"),
            ...
            },
            {
              ...
              value: function() {
                var e = this.container.style,
                  ...
                  n = "";
                "none" !== t &&
                  (n = this.getFilterStyle(t, this.filterStrength));
                var o = "blur" === t;
                (e.webkitFilter = o ? "" : n),
                  (e.filter = o ? "" : n),
            ...
            },
            {
              ...
              value: function(e, t) {
                return (
                  e +
                  "(" +
                  (f.filterProperties[e].modifier(t) +
                    f.filterProperties[e].unit) +
                  ")"
                );
              }
            },
            {
              ...
              value: function(e) {
                this.DEBUG.enabled &&
                  this.DEBUG.verbose &&
                  this.windowContext.console.log(e);
              }
            }
          ]),
          e
  ...
  function(e, t, n) {
    (function(e, n) {
      ...
      function O(e, t) {
        ...
        if (n instanceof E) {
          var o = n.__data__;
          if (!en || o.length < Ne - 1) return o.push([e, t]), this;
      ...
      function Z(e, t, n, o, r, i, s) {
        ...
        var c = pn(e);
        if (c) {
          if (((l = ge(e)), !t)) return ue(e, l);
        } else {
          var u = hn(e),
            d = u == qe || u == Je;
          if (yn(e)) return ne(e, t);
          if (u == $e || u == Qe || (d && !i)) {
            if (A(e)) return i ? e : {};
            if (((l = ve(d ? {} : e)), !t)) return Ae(e, Q(l, e));
          } else {
            if (!Et[u]) return i ? e : {};
            l = me(e, u, Z, t);
          }
        ...
        var f = s.get(e);
        if (f) return f;
        if ((s.set(e, l), !c)) var h = n ? he(e) : Ue(e);
        return (
          a(h || e, function(r, i) {
        ...
        d &&
          ...
          pn(l) || gn(l)
            ...
            ? Pe(s)
              ...
              : (u = s)
            : (d = !1)),
          d && (a.set(l, u), r(u, l, o, i, a), a.delete(l)),
          N(e, n, u);
      }
      function te(e, t) {
        return (
          ...
          function() {
            for (
              var n = arguments, o = -1, r = Kt(n.length - t, 0), a = Array(r);
              ++o < r;
        ...
        return te(function(t, n) {
          ...
          for (
            i = e.length > 3 && "function" == typeof i ? (r--, i) : void 0,
              a && we(n[0], n[1], a) && ((i = r < 3 ? void 0 : i), (r = 1)),
              t = Object(t);
            ++o < r;
      ...
      function Ye(e) {
        if (!Be(e) || Mt.call(e) != $e || A(e)) return !1;
        var t = Zt(e);
        if (null === t) return !0;
      ...
      var Ne = 200,
        ...
        bt = /^(?:0|[1-9]\d*)$/,
        wt = {};
      (wt[lt] = wt[ct] = wt[ut] = wt[dt] = wt[At] = wt[ft] = wt[ht] = wt[
        pt
      ] = wt[yt] = !0),
        (wt[Qe] = wt[Ze] = wt[at] = wt[He] = wt[st] = wt[We] = wt[ze] = wt[
          qe
        ] = wt[Xe] = wt[Ke] = wt[$e] = wt[tt] = wt[nt] = wt[ot] = wt[it] = !1);
      var Et = {};
      (Et[Qe] = Et[Ze] = Et[at] = Et[st] = Et[He] = Et[We] = Et[lt] = Et[
        ct
      ] = Et[ut] = Et[dt] = Et[At] = Et[Xe] = Et[Ke] = Et[$e] = Et[tt] = Et[
        nt
      ] = Et[ot] = Et[rt] = Et[ft] = Et[ht] = Et[pt] = Et[yt] = !0),
        (Et[ze] = Et[qe] = Et[it] = !1);
      ...
      var fn = qt ? h(qt, Object) : Oe,
        hn = z;
      (($t && hn(new $t(new ArrayBuffer(1))) != st) ||
        (en && hn(new en()) != Xe) ||
        (tn && hn(tn.resolve()) != et) ||
        (nn && hn(new nn()) != nt) ||
        (on && hn(new on()) != it)) &&
      ...
      s = function() {
        return new Promise(function(e, t) {
          ...
          (n.autoplay = !0),
            ...
            n.setAttribute(
              "style",
              "width: 1px; height: 1px; position: fixed; top: 0; left: 0; z-index: 100;"
            ),
            ...
            if (
              ...
              if (
                ...
                return (
                  s(),
                  void t(
                    "no autoplay: element does not support mp4 or ogg format"
                  )
                );
              n.src = a;
            }
          ...
          n.addEventListener("play", function() {
            ...
            n.addEventListener("canplay", function() {
              return "true" === n.getAttribute("data-is-playing")
                ? (s(), e("autoplay supported"), !0)
                : (s(),
  ...
  function(e, t, n) {
    ...
    var o = n(15),
      ...
      c = function(e, t) {
        ...
        i.ownerDocument.defaultView.eval(
      ...
      u = function(e) {
        ...
        return new Promise(function(e, h) {
          ...
          g.appendChild(i);
          var v = { iframe: i, setPlaybackRate: function() {} };
          e(v);
          var m = function() {
            ...
            w = function() {
              ...
              (e ||
                (v.dimensions.width && v.dimensions.height && v.duration)) &&
                (e && m(),
                (v.dimensions.width =
                  v.dimensions.width || v.iframe.parentNode.offsetWidth),
                (v.dimensions.height =
                  v.dimensions.height || v.iframe.parentNode.offsetHeight),
              ...
              switch (("string" == typeof t && (t = JSON.parse(t)), t.event)) {
                ...
                case "timeupdate":
                  b && (clearTimeout(b), (b = null)),
                    f("playing", t),
                    c("setVolume", "0"),
                    t.data.percent >= 0.98 && d > 0 && c("seekTo", d);
              }
              switch (t.method) {
                case "getVideoHeight":
          ...
          t.addEventListener("message", k, !1),
            (v.destroy = function() {
              t.removeEventListener("message", k),
                v.iframe.parentElement &&
                  v.iframe.parentElement.removeChild(v.iframe);
            }),
  ...
  function(e, t, n) {
    ...
    var r =
      ...
      d = function(e) {
        ...
        return (
          e.dimensions
            ? ((t = e.dimensions.width), (n = e.dimensions.height))
            : e.iframe &&
              ((t = e.iframe.clientWidth), (n = e.iframe.clientHeight)),
          { w: t, h: n }
        );
      },
      A = {
      ...
      p = function() {
        var e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : i.DEFAULT_PROPERTY_VALUES.url,
          t = e.match(i.YOUTUBE_REGEX);
        return t && t[2].length
          ? "youtube"
          : ((t = e.match(i.VIMEO_REGEX)),
            t && t[2].length
              ? "vimeo"
              : void console.error(
                  "Video source " + e + " does not match supported types"
                ));
      },
      y = function() {
        var e =
        ...
        return n && n[2].length
          ? n[2]
          : void console.error("Video id at " + e + " is not valid");
      },
      g = function(e) {
        if (!e) return !1;
  ...
  function(e, t, n) {
    ...
    function r(e, t, n) {
      ...
      var c,
        ...
        y = this,
        g = 0;
      "object" !== p && "string" !== p && ((n = t), (t = null)),
        n && "function" != typeof n && (n = s.parse),
        (t = a(t));
      var v = o(e);
      for (
        y.protocol = v.protocol || t.protocol || "",
          y.slashes = v.slashes || t.slashes,
          e = v.rest;
        g < u.length;
        g++
      )
        (d = u[g]),
          ...
          c !== c
            ...
            ? ~(A = e.indexOf(c)) &&
              ("number" == typeof d[2]
                ? ((y[f] = e.slice(0, A)), (e = e.slice(A + d[2])))
                : ((y[f] = e.slice(A)), (e = e.slice(0, A))))
            : (A = c.exec(e)) &&
              ((y[f] = A[1]), (e = e.slice(0, e.length - A[0].length))),
          (y[f] = y[f] || (d[3] || ("port" === f && h) ? t[f] || "" : "")),
          d[4] && (y[f] = y[f].toLowerCase());
      n && (y.query = n(y.query)),
        i(y.port, y.protocol) || ((y.host = y.hostname), (y.port = "")),
    ...
    (r.prototype.set = function(e, t, n) {
      ...
      return (
        "query" === e
          ...
          ? ((o[e] = t),
            /\:\d+/.test(t) &&
              ((t = t.split(":")), (o.hostname = t[0]), (o.port = t[1])))
          : "protocol" === e
          ? ((o.protocol = t), (o.slashes = !n))
          : (o[e] = t),
        (o.href = o.toString()),
        o
      );
  ...
  function(e, t) {
    ...
    function n(e) {
      for (
        var t, n = /([^=?&]+)=?([^&]*)/g, o = {};
        (t = n.exec(e));
        o[decodeURIComponent(t[1])] = decodeURIComponent(t[2])
      );
      return o;
    }
    function o(e, t) {
  ...
  function(e, t) {
    (function(t) {
      ...
      function T(e, t) {
        t = I(t, e) ? [t] : _(t);
        for (var n = 0, o = t.length; null != e && n < o; ) e = e[F(t[n++])];
      ...
      function I(e, t) {
        ...
        return (
          ...
          (q.test(e) || !z.test(e) || (null != t && e in Object(t)))
        );
      }
      function R(e) {
        var t = typeof e;
    ...
    var o = n(15),
        ...
        return new Promise(function(t, n) {
          if (
            e.document.documentElement.querySelector(
              'script[src*="www.youtube.com/iframe_api"].loaded'
            )
          )
      ...
      a = function(e, t, n) {
        var o =
          ...
          i = (r.getDuration() - t) / o,
          a = function e() {
            r.getCurrentTime() + 0.1 >= r.getDuration() &&
              (r.pauseVideo(), r.seekTo(t), r.playVideo()),
              requestAnimationFrame(e);
          };
        return e.data === n.YT.PlayerState.BUFFERING &&
          1 !== r.getVideoLoadedFraction() &&
          (0 === r.getCurrentTime() || r.getCurrentTime() > i - -0.1)
          ? "buffering"
  ...
  function(e, t) {
    var n = function(e) {
      var t = { container: e };
      return (
        e.getAttribute("data-config-url") &&
          (t.url = e.getAttribute("data-config-url")),
        e.getAttribute("data-config-playback-speed") &&
          (t.playbackSpeed = e.getAttribute("data-config-playback-speed")),
        e.getAttribute("data-config-filter") &&
          (t.filter = e.getAttribute("data-config-filter")),
        e.getAttribute("data-config-filter-strength") &&
      ...
      window.Singleton.create({
        ready: function() {
          (this._touch = Y.one(".touch-styles")),
            this.bindUI(),
            this._touch ||
              (this.folderRedirect(".folder-toggle", "#headerNav"),
              this.folderRedirect(".folder-toggle", "#footer")),
            this.folderActive(".folder-toggle", "#mobileNavigation"),
            this.folderActive(".folder-toggle", "#headerNav"),
            this.folderActive(".folder-toggle", "#footer"),
            this.folderNavExpand(".folder-nav-toggle", "#folderNav"),
            this.folderNavExpand(".category-nav-toggle", "#categoryNav");
        },
        bindUI: function() {
          this.dataToggleBody(),
            this.dataToggleEl(),
              ...
              t.delegate(
                ...
                function(e) {
                  ...
                  t
                    ? (window.location = t)
                    : console.warn(
                        "folderRedirect: You must add a data-href attribute to the label."
                      );
                },
                e
              );
        ...
        dataLightbox: function() {
          ...
          Y.all("[data-lightbox]").each(function(t) {
            ...
            (e[n] = e[n] || []),
              e[n].push({ content: t, meta: t.getAttribute("alt") }),
        ...
        _getSamePageHash: function(e) {
          ...
          return e.host !== t.host || e.pathname !== t.pathname || "" === e.hash
            ? null
            : e.hash;
        },
        smoothScrollTo: function(e) {
          if (!Y.Lang.isNumber(e))
            try {
              ...
              return (
                console.warn(
                  "helpers.js: scrollTo was passed an invalid argument."
                ),
                !1
              );
            }
  ...
  function(e, t, n) {
    var o = n(2),
      ...
      i =
        null !==
        document.documentElement.getAttribute("data-authenticated-account");
    i &&
      Y.use("node", function(e) {
        window.Singleton.create({
          ready: function() {
          ...
          bindUI: function() {
            ...
            t &&
              ((t = t.getDOMNode()),
              [
                "sqs-stacked-items-dom-deleted",
                "sqs-stacked-items-dom-reorder"
              ].forEach(
                function(n) {
                  e.config.win.addEventListener(
                    n,
                    function(e) {
                      var n = t.querySelector("#content > div");
                      n.querySelector(".banner-thumbnail-wrapper") ||
                      n.querySelector(".promoted-gallery-wrapper").children
                        .length
                        ? t.classList.add("has-banner-image")
                        : t.classList.remove("has-banner-image");
                    }.bind(this)
                  );
                }.bind(this)
              ));
